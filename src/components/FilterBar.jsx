...
const FilterDropdown = ({ title, options }) => {
    ...
    return (
        <div className="dropdown w-full sm:w-fit">
            <label
                tabIndex={0}
                className=" text-nowrap btn text-[16px] font-[Inter]  font-normal hover:bg-[#1D994A] btn-outline outline-none m-1 rounded-[100px] w-full sm:w-fit justify-between"
            >
                {selected}{" "}
                <span className="ml-2">
                    <IoMdArrowDropdown />
